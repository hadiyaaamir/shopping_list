...
final class ParentListInvitationAccepted extends ParentListEvent {
  const ParentListInvitationAccepted({required this.shoppingList});
  final ShoppingList shoppingList;
  @override
  List<Object> get props => [shoppingList];
}

final class ParentListInvitationRejected extends ParentListEvent {
  const ParentListInvitationRejected({required this.shoppingList});
  final ShoppingList shoppingList;
  @override
  List<Object> get props => [shoppingList];
}
